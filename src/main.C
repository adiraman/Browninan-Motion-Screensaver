...
int main()
{
    ...
    parda.loadMusic("src/highTechLab.flac");
    ...
    while(true)
    {
        ...
        //update the particles before the next iteration
        ...
        for(int i=0; i<swarm::NPARTICLES; i++)
        {
            ...
            int x = (p.m_x + 1)*screen::SCREEN_WIDTH*0.5;
            int y = (p.m_y + 1)*screen::SCREEN_WIDTH*0.5;
